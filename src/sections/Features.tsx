        ...
        <section className="py-24">
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="aspect-videp flex items-center justify-center">
                    ...
                    >
                        <div className="aspect-videp flex items-center justify-center">
                            <p className="text-4xl font-extrabold text-white/20 text-center">We have achieved <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">incredible</span>{" "}growth this year</p>
                        </div>
                    </FeatureCard>
                    ...
                    >
                        <div className="aspect-video flex gap-4 items-center ">
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map(feature => (
                        <div key={feature} className="bg-neutral-900 border border-white/10 inline-flex px-3 py-1.5 rounded-2xl gap-3 items-center  md:px-3 md:py-2" >
                            <span className="bg-lime-400 text-neutral-950 size-5 rounded-full inline-flex text-center items-center justify-center text-xl">&#10038;</span>

    ...
    return (
        <section className="py-24">
            <div className="container">
                ...
                <h2 className="text-6xl font-medium mt-6 text-center md-w-xl max-auto">Questions? We've got <span className="text-lime-400">answer</span></h2>
                ...
                <div className="mt-12 flex flex-col gap-6 max-w-xl mx-auto">
                    {faqs.map((faq, faqIndex) => (
                        <div key={faq.question} className="bg-neutral-900 rounded-2xl border border-white/10 p-6">
                            ...
                            <div className={twMerge("mt-15", selectedIndex !== faqIndex && "hidden")}>
